...
"[project]/Downloads/code (1)/app/dashboard/products/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProductsPage() {
    ...
    const [shopSlug, setShopSlug] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$code__$28$1$292f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$code__$28$1$292f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [deletingId, setDeletingId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$code__$28$1$292f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const loadProducts = async ()=>{
        try {
            ...
            const { data: shop, error: shopError } = await supabase.from("shops").select("id, slug").eq("user_id", user.id).single();
            if (shopError || !shop) {
            ...
            const { data, error } = await supabase.from("products").select("id, name, price, quantity, status, image_url, created_at").eq("shop_id", shop.id).order("created_at", {
                ascending: false
            });
            if (error) {
    ...
    const handleDeleteProduct = async (productId)=>{
        const confirmDelete = window.confirm("Are you sure you want to delete this product and all related data (images, order items)?");
        if (!confirmDelete) return;
        try {
            setDeletingId(productId);
            // 1) Supprimer les lignes de order_items liées à ce produit
            const { error: orderItemsError } = await supabase.from("order_items").delete().eq("product_id", productId);
            if (orderItemsError) {
                console.error("Error deleting order items:", orderItemsError);
                alert("Failed to delete order items for this product: " + orderItemsError.message);
                setDeletingId(null);
                return;
            }
            ...
            alert("Failed to delete product: " + (err?.message || "Unexpected error"));
        } finally{
            setDeletingId(null);
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$code__$28$1$292f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$code__$28$1$292f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                className: "border rounded-lg p-6 text-center text-sm text-gray-500",
                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$code__$28$1$292f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$code__$28$1$292f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$code__$28$1$292f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                ...
                                                children: deletingId === p.id ? "Suppression..." : "Supprimer"
                                            }, void 0, false, {
                                                fileName: "[project]/Downloads/code (1)/app/dashboard/products/page.tsx",
                                                lineNumber: 229,
                                                columnNumber: 19
...
_s(ProductsPage, "qxsEHdnqvl0nJytd+9dyjeGxAoA=");
_c = ProductsPage;
var _c;
...
//# sourceMappingURL=Downloads_code%20%281%29_app_dashboard_products_page_tsx_220022b7._.js.map